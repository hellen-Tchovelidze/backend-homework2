...
class ElectricCar extends Car {
  ...
  getInfoFull() {
    console.log(
      `Car: ${this.marke} ${this.model} ${this.year} Battery level: ${this.batteryLevel}`
    );
  }
}
...
// which have following methods addBook(), removeBook(), listBooks(). listBooks should have array of 
...
// 5)  Create a CarFactory class that have following methods, addCar, deleteCar, updateCar, 
//getAllCars. getAllCars should be array of objects with following properties: [
// {
...
// 7) Create a Class Inventory that holds a list of items, Each item has name, stock, price Methods: 
//addItem(), updateStock(name, quantity), checkAvailability(name), calculateValue()
